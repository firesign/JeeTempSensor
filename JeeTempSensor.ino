 ...
 * Modified by Michael LeBlanc, May 2013
 */
 
 // this version has serial.print statements commented-out
...
void setup() {
  ...
  rf12_initialize(4, RF12_433MHZ, 212);
  //Serial.println("Temp transmitter startup");
}
